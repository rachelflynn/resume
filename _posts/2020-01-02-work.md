...
- Update and maintain a library of over 100 API and apps framework technical documents on ReadMe
- Collaborate with developers to learn details about new APIs and accurately document them
- Author 25 technical specification documents to explain new objects and development features
- Contribute to the SDK in Github by adding three new methods and updating others as needed
- Write code samples for technical documentation in JavaScript, JSON, and GraphQL
- Spearhead the monthly builders’ e-newsletter for over 10,000 recipients
...
- Establish a resume design business and work with 50+ clients to enhance their resumes 
...
- Write and edit over 60 articles for two long-term clients in the AI and construction financing industries
- Craft 50 travel guides for Tourscanner
...
- Understood complex banking processes and write technical documentation that explains day-to-day branch operations 
- Reformatted and edit technical documentation written by others to ensure it follows internal standards and guidelines
- Built intranet webpages outlining branch operation procedures by migrating 100+ Word documents to OpenText
- Collaborated with teammates to develop efficient processes that streamline the migration process 
