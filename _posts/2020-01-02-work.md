...
- Led company-wide technical documentation efforts by building comprehensive developer and knowledgebase documentation
- Updated and maintained a library of more than 130 API, apps framework, and app marketplace technical documents using Markdown and HTML
- Crafted documentation for 6 different monday AI app features
- Built a release process for 25 developers across 3 teams to align documentation and feature releases
- Collaborated with SMEs to maintain product knowledge and perform quality assurance reviews on 80% of existing API documentation
- Authored 30 technical specification documents to explain new GraphQL resolvers, apps framework features, and SDK methods
- Wrote code samples in languages like Javascript, GraphQL, and JSON
- Spearheaded the monthly builders’ e-newsletter for over 10,000 recipients
