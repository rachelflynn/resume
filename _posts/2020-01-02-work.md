...
monday.com \| Remote \| July 2022 - present

- Owned end-to-end API and app documentation as the company’s inaugural technical writer
- Led the documentation and rollout strategy for API versioning, helping establish one of the industry’s first versioned GraphQL APIs 
- Authored 150+ technical specifications and maintained a library of 200+ API, app framework, AI, and marketplace documents supporting developers at scale
- Drove adoption of a Docs as Code model, unifying dev teams in a scalable, consistent release pipeline
- Built a cross-domain release process spanning 10 product domains to synchronize documentation with feature launches
- Launched an AI chatbot that deflected 150,000+ documentation requests, significantly reducing support dependency
- Performed API QA testing, contributed design feedback, and produced multi-language code samples (JS, JSON, GraphQL, cURL, Python, Shell)
